CREATE DATABASE  IF NOT EXISTS `roydon5` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `roydon5`;
-- MySQL dump 10.13  Distrib 8.0.28, for macos11 (x86_64)
--
-- Host: localhost    Database: roydon5
-- ------------------------------------------------------
...
INSERT INTO `application` VALUES (2,'Java, Python, SQL','MSCS(Northeastern University)',NULL,'Saved',53,1,NULL),(3,'Java, Python, SQL','MSCS(Northeastern University)',NULL,'Submitted',52,1,'2022-04-28 02:29:08'),(4,'Java, Python, SQL','MSCS(Northeastern University)',NULL,'Saved',51,1,NULL),(5,'Tissue Culture, RTPCR, MassSpectrometry','MSBiotech(Northeastern University)',NULL,'Submitted',5,2,'2022-04-28 03:40:09'),(6,'Pharmacy, Chemistry','MSBiotech(Northeastern University)',NULL,'Submitted',3,2,'2022-04-28 02:29:08');
...
INSERT INTO `document` VALUES (2,'resume','http://testdocument1.com',2),(3,'resume','http://testdocument2.com',3),(4,'resume','http://testdocument3.com',4),(5,'cv','http://cvdocument.com',5),(6,'cv','http://cvdocument.com',6);
...
CREATE TABLE `user` (
  ...
  KEY `fk_userorganizationid_idx` (`organizationid`),
  CONSTRAINT `fk_roleid` FOREIGN KEY (`role_id`) REFERENCES `role` (`roleid`),
  CONSTRAINT `fk_userorganizationid` FOREIGN KEY (`organizationid`) REFERENCES `organization` (`orgid`)
...
INSERT INTO `user` VALUES (2,'bs@gmail.com','Bree','Snider','abc12345','bio2',1,NULL),(4,'ck@kforce.com','Callum','Mckenzie','abc12345','Recruiting for kforce affiliated companies',2,2),(3,'kh@kforce.com','Kirstie','Hibbert','abc12345','Recruiting for kforce affiliated companies',2,2),(1,'mc@gmail.com','Macie','Chen','abc12345','bio1',1,NULL);
/*!40000 ALTER TABLE `user` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'roydon5'
--
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `create_new_application`(IN userid int, IN skills varchar(45), IN education varchar(45),
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_all_applicant_applications`(IN userid int)
BEGIN
	SELECT 
    a.applicationid,
    a.skills,
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_saved_application`(IN appid int, IN skills varchar(45), 
...
-- Dump completed on 2022-04-28  3:47:52
